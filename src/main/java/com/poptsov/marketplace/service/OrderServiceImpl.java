...
public class OrderServiceImpl implements OrderService {
    ...
    @Transactional
    public OrderReadDto delete(Integer id) {
        ...
        return orderReadMapper.map(orderRepository.deleteOrderById(id));
    }

    // CRUD end

    @Transactional
    public OrderReadDto updateStatus(Integer id, OrderEditStatusDto orderEditStatusDto) {
